...
static int64_t CastC__Castelluccia__decrypt(int64_t *c, int64_t n, int64_t k, char *m);
#line 2
static int64_t CastC__Castelluccia__encrypt(int64_t *m, int64_t n, int64_t k, char *c);
static int64_t TestCastC__Castelluccia__decrypt(int64_t *c, int64_t n, int64_t k, char *m);
#line 2
static int64_t TestCastC__Castelluccia__encrypt(int64_t *m, int64_t n, int64_t k, char *c);
# 16 "TestCastC.nc"
...
# 15 "CastC.nc"
static inline int64_t CastC__Castelluccia__encrypt(int64_t *m, int64_t n, int64_t k, char *c);
#line 31
static inline int64_t CastC__Castelluccia__decrypt(int64_t *c, int64_t n, int64_t k, char *m);
...
# 3 "/opt/tinyos-2.1.1/tos/interfaces/Castelluccia.nc"
inline static int64_t TestCastC__Castelluccia__decrypt(int64_t *c, int64_t n, int64_t k, char *m){
#line 3
...
inline static int64_t TestCastC__Castelluccia__encrypt(int64_t *m, int64_t n, int64_t k, char *c){
#line 2
  long long __nesc_result;
#line 2
