...
static void TestCastC$Boot$booted(void );
...
static int64_t CastC$Castelluccia$decrypt(int64_t c, int64_t n, int64_t k, int64_t m);
#line 2
static int64_t CastC$Castelluccia$encrypt(int64_t *m, int64_t n, int64_t k, int64_t c);
static int64_t TestCastC$Castelluccia$decrypt(int64_t c, int64_t n, int64_t k, int64_t m);
#line 2
static int64_t TestCastC$Castelluccia$encrypt(int64_t *m, int64_t n, int64_t k, int64_t c);
# 16 "TestCastC.nc"
static inline void TestCastC$Boot$booted(void );
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
# 15 "CastC.nc"
static inline int64_t CastC$Castelluccia$encrypt(int64_t *m, int64_t n, int64_t k, int64_t c);
#line 31
static inline int64_t CastC$Castelluccia$decrypt(int64_t c, int64_t n, int64_t k, int64_t m);
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4083d7f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4083d7f0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4083d158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4083d158, msg, payload, len);
#line 67
...
# 3 "/opt/tinyos-2.1.1/tos/interfaces/Castelluccia.nc"
inline static int64_t TestCastC$Castelluccia$decrypt(int64_t c, int64_t n, int64_t k, int64_t m){
#line 3
  long long __nesc_result;
#line 3

#line 3
  __nesc_result = CastC$Castelluccia$decrypt(c, n, k, m);
#line 3
...
#line 15
{
  ...
  sim_log_debug(111U, "Boot", "values of a  is %d \n ", a);
  c = (a + k) % n;
  return c;
}

# 2 "/opt/tinyos-2.1.1/tos/interfaces/Castelluccia.nc"
inline static int64_t TestCastC$Castelluccia$encrypt(int64_t *m, int64_t n, int64_t k, int64_t c){
#line 2
  long long __nesc_result;
#line 2

#line 2
  __nesc_result = CastC$Castelluccia$encrypt(m, n, k, c);
#line 2
...
#line 16
{
  ...
  c1 = TestCastC$Castelluccia$encrypt(m, n, k, c1);
  sim_log_debug(46U, "Boot", " encryption is %d  \n", c1);

  m1 = TestCastC$Castelluccia$decrypt(c1, n, k, m1);
  sim_log_debug(47U, "Boot", "decryption is %d \n", m1);
}

# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 49
  TestCastC$Boot$booted();
#line 49
}
#line 49
