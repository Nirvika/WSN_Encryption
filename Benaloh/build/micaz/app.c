...
static void TestBenalohC__Boot__booted(void );
...
static uint32_t BenalohC__Benaloh__decrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
#line 11
static uint32_t BenalohC__Benaloh__encrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
...
static uint32_t TestBenalohC__Benaloh__decrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
#line 11
static uint32_t TestBenalohC__Benaloh__encrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
# 11 "TestBenalohC.nc"
uint32_t TestBenalohC__in = { 0x07, 0x0c };
uint32_t TestBenalohC__in2 = 12;
uint32_t TestBenalohC__out;
#line 13
uint32_t TestBenalohC__out2;


static inline void TestBenalohC__Boot__booted(void );
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
# 19 "/opt/tinyos-2.1.1/tos/interfaces/Benaloh.nc"
inline static uint32_t TestBenalohC__Benaloh__decrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out){
#line 19
  unsigned long __nesc_result;
#line 19

#line 19
  __nesc_result = BenalohC__Benaloh__decrypt(in, y, p, q, out);
#line 19
...
#line 19
#line 11
inline static uint32_t TestBenalohC__Benaloh__encrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out){
#line 11
  unsigned long __nesc_result;
#line 11

#line 11
  __nesc_result = BenalohC__Benaloh__encrypt(in, y, p, q, out);
#line 11
...
#line 25
  ...
  g = TestBenalohC__Benaloh__encrypt(TestBenalohC__in, y, p, q, TestBenalohC__out);
  z = TestBenalohC__Benaloh__encrypt(TestBenalohC__in2, y, p, q, TestBenalohC__out2);
  ;
  ;

  h = TestBenalohC__Benaloh__decrypt(g1, y, p, q, x);
  d = TestBenalohC__Benaloh__decrypt(z1, y, p, q, f);
  ;
  ;
}
