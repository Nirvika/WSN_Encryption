...
# 149 "/usr/lib/i386-linux-gnu/gcc/i686-linux-gnu/4.5.2/include/stddef.h" 3
...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40340438, const void *arg_0x403405d0);
#line 776
__extension__ 
#line 793
__extension__ 
...
# 40 "/usr/lib/i386-linux-gnu/gcc/i686-linux-gnu/4.5.2/include/stdarg.h" 3
...
unsigned int (*hashfunction)(void *arg_0x404ce320), 
int (*key_eq_fn)(void *arg_0x404ce768, void *arg_0x404ce8e0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40606010, int arg_0x40606168);
static inline double RandomUniform(void );
...
static void TestBenalohC$Boot$booted(void );
...
#line 122
message_t * amsg);
# 19 "/opt/tinyos-2.1.1/tos/interfaces/Benaloh.nc"
static uint32_t BenalohC$Benaloh$decrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
#line 11
static uint32_t BenalohC$Benaloh$encrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
...
static uint32_t TestBenalohC$Benaloh$decrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
#line 11
static uint32_t TestBenalohC$Benaloh$encrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out);
# 11 "TestBenalohC.nc"
uint32_t TestBenalohC$in[1000];
uint32_t TestBenalohC$in2[1000];
uint32_t TestBenalohC$out[1000];
#line 13
uint32_t TestBenalohC$out2[1000];


static inline void TestBenalohC$Boot$booted(void );
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
enum SimSchedulerBasicP$__nesc_unnamed4295 {
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4084e7f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4084e7f0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4084e158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4084e158, msg, payload, len);
#line 67
...
#line 230
  sim_log_debug(112U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
...
static inline void SimSchedulerBasicP$Scheduler$init(void )
{
  sim_log_debug(99U, "Scheduler", "Initializing scheduler.\n");
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40389ce0){
#line 64
    SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40389ce0);
#line 64
}
#line 64
# 42 "/opt/tinyos-2.1.1/tos/platforms/mica/PlatformP.nc"
...
#line 54
# 84 "/opt/tinyos-2.1.1/tos/lib/tossim/SimMainP.nc"
static inline error_t SimMainP$SoftwareInit$default$init(void )
#line 84
{
#line 84
...
# 19 "/opt/tinyos-2.1.1/tos/interfaces/Benaloh.nc"
inline static uint32_t TestBenalohC$Benaloh$decrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out){
#line 19
  unsigned int __nesc_result;
#line 19

#line 19
  __nesc_result = BenalohC$Benaloh$decrypt(in, y, p, q, out);
#line 19
...
#line 19
#line 11
inline static uint32_t TestBenalohC$Benaloh$encrypt(uint32_t in, uint32_t y, uint32_t p, uint32_t q, uint32_t out){
#line 11
  unsigned int __nesc_result;
#line 11

#line 11
  __nesc_result = BenalohC$Benaloh$encrypt(in, y, p, q, out);
#line 11
...
#line 25
  ...
  g = TestBenalohC$Benaloh$encrypt(TestBenalohC$in[sim_node()], y, p, q, TestBenalohC$out[sim_node()]);
  z = TestBenalohC$Benaloh$encrypt(TestBenalohC$in2[sim_node()], y, p, q, TestBenalohC$out2[sim_node()]);
  sim_log_debug(46U, "Boot", "%02x \n", g);
  sim_log_debug(47U, "Boot", "%02x \n", z);

  h = TestBenalohC$Benaloh$decrypt(g1, y, p, q, x);
  d = TestBenalohC$Benaloh$decrypt(z1, y, p, q, f);
  sim_log_debug(48U, "Boot", "%02x \n", h);
  sim_log_debug(49U, "Boot", "%02x \n", d);
}

# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 49
  TestBenalohC$Boot$booted();
#line 49
}
#line 49
...
#line 151
  ...
  sim_log_debug(107U, "SimMoteP", "Turning on mote %i at time %s.\n", (int )sim_node(), buf);
...
#line 67
  ...
  sim_log_debug(98U, "SimMainP", "Mote %li signaling boot at time %s.\n", sim_node(), timeBuf);
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      ...
      if (nextTask == SimSchedulerBasicP$NO_TASK) 
        {
          sim_log_debug(100U, "Scheduler", "Told to run next task, but no task to run.\n");
          {
...
#line 185
    __nesc_atomic_end(__nesc_atomic); }
#line 184
  sim_log_debug(101U, "Scheduler", "Running task %hhu.\n", nextTask);
...
#line 74
{
  ...
  uint32_t i = pow(y, in);
  uint32_t j = pow(BenalohC$u[sim_node()], 3);
  uint32_t s = i * j;
  uint32_t f = p * q;
...
#line 110
  ...
  sim_log_debug(105U, "SimMoteP", "Fetched %s of %i to be %p with len %i (result %i)\n", name, mote, *ptr, *len, result);
  sim_set_node(tmpID);
  return result;
}
...
{
  /* Module TestBenalohC */
  if (!strcmp(varname, "TestBenalohC$in"))
  {
    *addr = (uintptr_t)&TestBenalohC$in[__nesc_mote];
    *size = sizeof(TestBenalohC$in[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestBenalohC$in2"))
  {
    *addr = (uintptr_t)&TestBenalohC$in2[__nesc_mote];
    *size = sizeof(TestBenalohC$in2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestBenalohC$out"))
  {
    *addr = (uintptr_t)&TestBenalohC$out[__nesc_mote];
    *size = sizeof(TestBenalohC$out[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestBenalohC$out2"))
  {
    *addr = (uintptr_t)&TestBenalohC$out2[__nesc_mote];
    *size = sizeof(TestBenalohC$out2[__nesc_mote]);
    return 0;
  }
  ...
  /* Module BenalohC */
  if (!strcmp(varname, "BenalohC$u"))
  {
    *addr = (uintptr_t)&BenalohC$u[__nesc_mote];
    *size = sizeof(BenalohC$u[__nesc_mote]);
    return 0;
  }
...
{
  /* Module TestBenalohC */
  memcpy((void *)&TestBenalohC$in[__nesc_mote], (void *)&(unsigned int ){ 0x12 }, sizeof TestBenalohC$in[__nesc_mote]);
  memcpy((void *)&TestBenalohC$in2[__nesc_mote], (void *)&(unsigned int ){ 0x10 }, sizeof TestBenalohC$in2[__nesc_mote]);
  memset((void *)&TestBenalohC$out[__nesc_mote], 0, sizeof TestBenalohC$out[__nesc_mote]);
  memset((void *)&TestBenalohC$out2[__nesc_mote], 0, sizeof TestBenalohC$out2[__nesc_mote]);
