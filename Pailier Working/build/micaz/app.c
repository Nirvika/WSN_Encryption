...
# 333 "/usr/lib/gcc/avr/4.1.2/../../../../avr/include/math.h" 3
...
static void TestPailierC__Boot__booted(void );
...
static uint64_t PailierC__Pailier__decrypt(uint64_t in, uint64_t g, uint64_t h, uint64_t p, uint64_t q, uint64_t out);
#line 11
static uint64_t PailierC__Pailier__encrypt(uint64_t in, uint64_t g, uint64_t n, uint64_t out);
...
static uint64_t TestPailierC__Pailier__decrypt(uint64_t in, uint64_t g, uint64_t h, uint64_t p, uint64_t q, uint64_t out);
#line 11
static uint64_t TestPailierC__Pailier__encrypt(uint64_t in, uint64_t g, uint64_t n, uint64_t out);
# 13 "TestPailierC.nc"
static uint64_t TestPailierC__gcd(uint64_t a, uint64_t b);
#line 38
static inline uint64_t TestPailierC__lcm(uint64_t a, uint64_t b);
...
static inline void TestPailierC__Boot__booted(void );
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
# 16 "PailierC.nc"
static inline uint64_t PailierC__gcd(uint64_t a, uint64_t b);
#line 43
static inline uint64_t PailierC__lcm(uint64_t a, uint64_t b);
#line 134
static uint64_t PailierC__Pailier__encrypt(uint64_t in, uint64_t g, uint64_t n, uint64_t out);
#line 158
static uint64_t PailierC__Pailier__decrypt(uint64_t de, uint64_t g, uint64_t h, uint64_t p, uint64_t q, uint64_t out);
...
# 19 "/opt/tinyos-2.1.1/tos/interfaces/Pailier.nc"
inline static uint64_t TestPailierC__Pailier__decrypt(uint64_t in, uint64_t g, uint64_t h, uint64_t p, uint64_t q, uint64_t out){
#line 19
  unsigned long long __nesc_result;
#line 19

#line 19
  __nesc_result = PailierC__Pailier__decrypt(in, g, h, p, q, out);
#line 19
...
#line 19
#line 11
inline static uint64_t TestPailierC__Pailier__encrypt(uint64_t in, uint64_t g, uint64_t n, uint64_t out){
#line 11
  unsigned long long __nesc_result;
#line 11

#line 11
  __nesc_result = PailierC__Pailier__encrypt(in, g, n, out);
#line 11
...
#line 38
{
  uint64_t u = a * b / TestPailierC__gcd(a, b);
...
#line 60
  ...
  if (TestPailierC__gcd(p * q, (p - 1) * (q - 1)) == 1) {
      ;


      l = TestPailierC__lcm(p - 1, q - 1);
      ;
      e = 2;
      *c = pow(e, l);
      y = *c % squ;
      ...
      if (TestPailierC__gcd(a, n) == 1) {
          ...
          out1 = TestPailierC__Pailier__encrypt(in1, g, n, out1);
          out2 = TestPailierC__Pailier__encrypt(in2, g, n, out2);
          ;
          ;

          h1 = TestPailierC__Pailier__decrypt(out1, g, h, p, q, x);
          d = TestPailierC__Pailier__decrypt(out2, g, h, p, q, f);
          ;
          ;
        }
    }
...
#line 43
{
  uint64_t u = a * b / PailierC__gcd(a, b);
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x4037b630){
#line 64
    SchedulerBasicP__TaskBasic__default__runTask(arg_0x4037b630);
#line 64
}
#line 64
